...
def describe_game(name):
    ...
    # then they are a new playing and we need to get their name
    if name != "":
...
def score(nice,mean,name):
    ...
    if nice > 2: #if condition is valid, call win function passing in the variab les so it can use them
        win(nice,mean,name)
